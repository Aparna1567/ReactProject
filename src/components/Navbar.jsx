                    ...
                    <nav className='hidden md:flex flex-row items-center text-lg font-medium gap-8'>
                        ...
                        <div className='relative group'>
                            ...
                            <ul className='absolute hidden space-y-2 group-hover:block bg-white border border-gray-300 rounded-lg p-5'>
                                ...
                                <li><Link to="dishes" spy={true} smooth={true} duration={500} className='hover:text-brightColor transition-all cursor-pointer' >Spicy</Link></li>
                                <li><Link to="dishes" spy={true} smooth={true} duration={500} className='hover:text-brightColor transition-all cursor-pointer' >Tasty</Link></li>
                                <li><Link to="dishes" spy={true} smooth={true} duration={500} className='hover:text-brightColor transition-all cursor-pointer' >Delicious</Link></li>
                                <li><Link to="dishes" spy={true} smooth={true} duration={500} className='hover:text-brightColor transition-all cursor-pointer' >Crispy</Link></li>
